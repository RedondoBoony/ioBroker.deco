...
class DecoAPI {
    ...
    async _doLogin() {
        ...
        // The login button click triggers an XHR, NOT a page navigation.
        // Just click and wait for #map-clients to appear in the DOM.
    ...
    async _navigateToClients() {
        ...
        // Wait for at least one client row to appear
        await this._page.waitForSelector('tbody.grid-content-data tr', { timeout: 30000 });

        // Let the SPA finish rendering all rows
        await this._page.evaluate(() => new Promise(resolve => setTimeout(resolve, 1000)));
    }

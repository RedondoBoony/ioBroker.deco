...
/**
 * Locate an installed Chrome/Chromium executable.
 * Priority:
 *   1. PUPPETEER_EXECUTABLE_PATH environment variable
 *   2. Common system paths (Debian/Ubuntu/Raspberry Pi)
 *   3. 'which chromium-browser' / 'which chromium' shell lookup
 * Throws a helpful error if nothing is found.
 */
function resolveChromePath() {
    ...
    // 2. Known static paths on Debian / Ubuntu / Raspberry Pi OS
    const candidates = [
    ...
    throw new Error(
        'No Chrome/Chromium found on this system. ' +
        'Install it with:\n' +
